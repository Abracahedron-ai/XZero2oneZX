...
from src.backend.services.integrations.wrappers.asr.faster_whisper import FasterWhisperWrapper
from src.backend.services.integrations.wrappers.emotion.speech import SERWrapper


class YouTubeReferenceDetector:
    """Detect perfect phrases/emotions in YouTube videos."""
    
    def __init__(self, output_dir: Path = Path("runtime/logs/youtube_references")):
